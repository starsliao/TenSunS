...
## 🦄概述
>**ConsulManager**是一个使用Flask+Vue开发，基于Consul的WEB运维平台，弥补了Consul官方UI对Services管理的不足；并且基于Consul的服务发现与键值存储：实现了各云厂商多种资源与Prometheus的无缝同步，基于Blackbox对站点监控的可视化维护以及对自建与云上监控资源的优雅管理与展示。
